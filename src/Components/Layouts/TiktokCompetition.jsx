            ...
            <div className="w-4/6">
                ...
                <div className="p-7">
                  <div>
                    ...
                    <div className="flex my-4">
                      <ClockIcon />
                      <p className="ml-2">Jul 31, 2020</p>
                    </div>
                    <img
                      src="/images/tiktokcompetition.jpg"
                      alt="Tiktok"
              ...
              <div className="border border-gray-500 flex mx-6 my-10">
                <div className="border-r border-gray-500 text-left w-1/2">
                  <a href="/arsip-agenda/vlog-competition" className="w-full">
                    <div className="hover:text-orange-400 w-full h-full p-6">
                      <span className="text-sm text-gray-400 ">
                        Previous Post
                      </span>
                      <p className="text-lg font-semibold">VLOG Competition</p>
                    </div>
                  </a>
                </div>
              </div>
...
export default TiktokCompetition;
