...
const MahasiswaPBITurutHadirDalamMillennialRoadSafetyFestivalPematangsiantar =
  () => {
    return (
                  ...
                  <div className="p-7">
                    <div>
                      <h1 className="text-4xl font-semibold faceb">
                        Mahasiswa PBI Turut Hadir Dalam Millennial Road Safety
                        Festival Pematangsiantar
                      </h1>
                      <div className="flex my-4">
                        <ClockIcon />
                        <p className="ml-2">Mar 03, 2019</p>
                      </div>
                      <img
                      ...
                      <div className="text-justify">
                        <p className="my-4">
                          Mahasiswa turut berpartisipasi dan memeriahkan acara
                          Milenial Road Safety Festival Pematangsiantar yang di
                          selenggarakan oleh Kapolres Pematangsiantar.
                        </p>

                        <p className="my-4">
                          Relawan Pajak dari Kampus PBI Murni Sadar juga turut
                          berpartisipasi dalam acara Milenial Road Safety
                          Festival Pematangsiantar.
                        </p>
                      </div>
...
export default MahasiswaPBITurutHadirDalamMillennialRoadSafetyFestivalPematangsiantar;
